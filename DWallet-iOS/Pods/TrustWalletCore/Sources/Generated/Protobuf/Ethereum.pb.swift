...
public struct TW_Ethereum_Proto_UserOperation {
  ...
  public var accountFactory: String = String()

  /// Account logic contract address
  public var accountLogic: String = String()
  ...
  public var isAccountDeployed: Bool = false
...
extension TW_Ethereum_Proto_UserOperation: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    2: .standard(proto: "account_factory"),
    3: .standard(proto: "account_logic"),
    4: .same(proto: "owner"),
    5: .standard(proto: "is_account_deployed"),
    6: .standard(proto: "pre_verification_gas"),
    7: .standard(proto: "verification_gas_limit"),
    8: .standard(proto: "paymaster_and_data"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularStringField(value: &self.accountFactory) }()
      case 3: try { try decoder.decodeSingularStringField(value: &self.accountLogic) }()
      case 4: try { try decoder.decodeSingularStringField(value: &self.owner) }()
      case 5: try { try decoder.decodeSingularBoolField(value: &self.isAccountDeployed) }()
      case 6: try { try decoder.decodeSingularBytesField(value: &self.preVerificationGas) }()
      case 7: try { try decoder.decodeSingularBytesField(value: &self.verificationGasLimit) }()
      case 8: try { try decoder.decodeSingularBytesField(value: &self.paymasterAndData) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.accountFactory.isEmpty {
      try visitor.visitSingularStringField(value: self.accountFactory, fieldNumber: 2)
    }
    if !self.accountLogic.isEmpty {
      try visitor.visitSingularStringField(value: self.accountLogic, fieldNumber: 3)
    }
    if !self.owner.isEmpty {
      try visitor.visitSingularStringField(value: self.owner, fieldNumber: 4)
    }
    if self.isAccountDeployed != false {
      try visitor.visitSingularBoolField(value: self.isAccountDeployed, fieldNumber: 5)
    }
    if !self.preVerificationGas.isEmpty {
      try visitor.visitSingularBytesField(value: self.preVerificationGas, fieldNumber: 6)
    }
    if !self.verificationGasLimit.isEmpty {
      try visitor.visitSingularBytesField(value: self.verificationGasLimit, fieldNumber: 7)
    }
    if !self.paymasterAndData.isEmpty {
      try visitor.visitSingularBytesField(value: self.paymasterAndData, fieldNumber: 8)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  public static func ==(lhs: TW_Ethereum_Proto_UserOperation, rhs: TW_Ethereum_Proto_UserOperation) -> Bool {
    ...
    if lhs.accountFactory != rhs.accountFactory {return false}
    if lhs.accountLogic != rhs.accountLogic {return false}
    if lhs.owner != rhs.owner {return false}
    if lhs.isAccountDeployed != rhs.isAccountDeployed {return false}
