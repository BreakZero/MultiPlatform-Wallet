...
install_xcframework "${PODS_ROOT}/TrustWalletCore/WalletCoreCommon.xcframework" "WalletCoreCommon" "framework" "ios-arm64" "ios-arm64_x86_64-simulator" "ios-arm64_x86_64-maccatalyst"
